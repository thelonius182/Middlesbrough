...
for minute in range(1, 60):
    ...
    print()
    print(f"{minute:02d}: {minuuttekst}")

    for candidate in range(1, CANDIDATES + 1):
        seed = BASE_SEED + minute * 10 + candidate
        set_seed(seed)
        ...
        print(
            f"  kandidaat {candidate}, seed={seed}"
        )
...
if failed:
    print()
    print("Niet automatisch geknipt:")
    ...
    print("Alle fragmenten zijn automatisch geknipt.")
